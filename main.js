...
try {
  ...
  bot.on('message', async (msg) => {
    ...
    const msgden = `<blockquote>USER: @${userName}\nID: ${chatId}\n⚠️ ACCESS DENIED ⚠️\n\nJika kamu owner dari bot ini, sila gantikan USERID kamu dengan menaip diterminal, telegram-bot -cc dan tekan 2 lalu masukkan userid kamu yang sebenar <b>${chatId}</b> lalu restart service.</blockquote>`;
